...
function calcularAreaTriangulo() {
  ...
  let base = parseInt(prompt("Ingrese la longitud de la base del triángulo:"));
...
function ejercicioLargo() {
  ...
  if (k < 3 && fr === 'manzana') {
      ...
      d = pr * 0.02;
      tp = pr - d;
  } else if (k < 6 && fr === 'manzana') {
      pr = k * p;
      d = pr * 0.04;
      tp = pr - d;
  } else if (k < 17 && fr === 'manzana') {
      pr = k * p;
      d = pr * 0.10;
      tp = pr - d;
  } else if (k < 3 && fr === 'pera') {
      ...
      d = pr * 0.04;
      tp = pr - d;
  } else if (k < 17 && fr === 'pera') {
      pr = k * p;
      d = pr * 0.10;
      tp = pr - d;
  } else if (k < 3 && fr === 'sandia') {
      pr = k * p;
      d = pr * 0.02;
      tp = pr - d;
  } else if (k < 6 && fr === 'sandia') {
      pr = k * p;
      d = pr * 0.04;
      tp = pr - d;
  } else if (k < 17 && fr === 'sandia') {
      pr = k * p;
      d = pr * 0.10;
      tp = pr - d;
  }

  alert('El valor del descuento es: $' + d.toFixed(2) + ' pesos. El valor total a pagar es: $' + tp.toFixed(2) + ' pesos');
}
